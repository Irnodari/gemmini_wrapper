...
module ram_5x83(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [2:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [82:0] R0_data,
  ...
  reg [82:0] Memory[0:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[82:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
