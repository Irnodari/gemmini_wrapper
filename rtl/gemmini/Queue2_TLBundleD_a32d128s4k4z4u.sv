...
module Queue2_TLBundleD_a32d128s4k4z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [138:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x139 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_source, io_enq_bits_size, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[138:11];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
